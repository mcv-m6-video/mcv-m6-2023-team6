...
def rendering_video(
    path, annotations, predicted_boxes, video_capture, save=True, display=False
):
    wait_time = 1
    ...
    mIOU, mIOU_frame, AP = mean_AP_Pascal_VOC(
        gt_boxes, total, predicted_boxes, iou_th=0.5
    )
