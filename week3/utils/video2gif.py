...
def video2gif(video_path, gif_path, start_time, duration, fps):
    ...
    gif.speedx(5).to_gif(gif_path, fps=fps)


video2gif('/ghome/group03/mcv-m6-2023-team6/week3/Results/Video_IoU/video.mp4',
           '/ghome/group03/mcv-m6-2023-team6/week3/Results/Video_IoU/video_gif.gif', 0, None, 5)
...
def resize_gif(gif_path, new_gif_path, start_time, duration, fps):
    ...
    gif.speedx(5).to_gif(new_gif_path, fps=fps)
