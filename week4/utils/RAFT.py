...
def flow_raft(image1, image2, model='/ghome/group03/mcv-m6-2023-team6/week4/RAFT/models/raft-kitti.pth', colType = 1, small=True, mixed_precision=True, alternate_corr=True):
