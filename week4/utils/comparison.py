...
moviepy.editor.ImageSequenceClip(sequence=npyImages, fps=0.5).write_gif(filename='/ghome/group03/mcv-m6-2023-team6/week4/Results/Task1_2/comparison.gif', fps = 0.5)